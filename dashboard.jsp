...
<div class="w3-top">
  <div class="w3-bar w3-white w3-wide w3-padding w3-card">
    <a href="dashboard.jsp" class="w3-bar-item w3-button"><b>BR</b> Architects</a>
    <!-- Float links to the right. Hide them on small screens -->
    <div class="w3-right w3-hide-small">
      <a href="show_products.jsp" class="w3-bar-item w3-button">Previous Projects</a>
      <a class="w3-bar-item w3-button" href="insertForm.jsp">Insert Project</a>
...
<div class="w3-content w3-padding" style="max-width:1564px">
  ...
  <div class="w3-container w3-padding-32" id="projects">
    ...
    <a style="text-decoration: none;" href="insertForm.jsp" class="w3-bar-item w3-button">Insert Project</a>
  </div>
