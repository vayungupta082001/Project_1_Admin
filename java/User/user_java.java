 ...
 */
@WebServlet("/user_java")
public class user_java extends HttpServlet {
...
//		doGet(request, response);
		...
		try {
			...
			String script="select * from user_login where Username = '"+uname+"' and Password = '"+password+"' ";
...
//				pw.print("done");
				ses.setAttribute("cl_username", uname);
